...
$(document).ready(function () {
  ...
  $('.cover').slick({
    ...
    prevArrow:
      '<button type="button" class="slick-prev"><img src="./images/icons/arrows/triangleleft.svg"></button>',
    nextArrow:
      '<button type="button" class="slick-next"><img src="./images/icons/arrows/triangleright.svg"></img></button>',
